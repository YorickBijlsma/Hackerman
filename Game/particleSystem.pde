...
void playerDamageParticleEffect(float x, float y)
{
  playerDamageParticle.x0 = x;
  playerDamageParticle.y0 = y;
  
  playerDamageParticle.spreadFactor=2.4895105;
  playerDamageParticle.minSpeed=1.0;
  playerDamageParticle.maxSpeed=2.1328673;
  playerDamageParticle.startVx=0.0;
  playerDamageParticle.startVy=0.0069930553;
  playerDamageParticle.particleShape="line";
  playerDamageParticle.emitterType="point";
  playerDamageParticle.birthSize=6.5384617;
  playerDamageParticle.deathSize=6.5384617;
  playerDamageParticle.gravity=-0.0076923072;
  playerDamageParticle.birthColor=color(255.0, 0.0, 0.0, 255.0);
  playerDamageParticle.deathColor=color(0.0, 0.0, 0.0, 0.0);
  playerDamageParticle.blendMode="blend";
  playerDamageParticle.framesToLive=12;
}